...
{       
            ...
            'rules' => [
                [
                    ...
                    'matchCallback' => function ($rule, $action) {
                        return RecordHelpers::userIsOwner(Yii::$app->request->get('id'));
                    }
                ],
            ],
        ],
    ...
    /* public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $project_user->role_id = self::OWNER;

            $model2 = new User();
            $model2->findOne(yii::$app->user->id);
            
            $project_user->userEmail = $model2->email;
